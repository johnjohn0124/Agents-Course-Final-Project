...
VAL_PATH = "eval_transformed.json"
EVAL_PATH = "eval_transformed.json"
...
def train_sft_reward_model(model, train_path, val_path, tokenizer, epochs=3, batch_size=4, lr=2e-5, device="cuda"):
    """
    ...
    for seed in seeds:
        ...
        for model_name in model_scales:
            ...
            for data_size in data_diets:
                ...
                train_data_subset = load_data_subset(TRAIN_PATH, data_size)
                train_subset_path = f"/content/train_{data_size}.json"
                ...
                train_sft_reward_model(model, train_subset_path, VAL_PATH, tokenizer, epochs=epochs)
